...
public class FluentValidationSubscription : IDisposable
{
    ...
    private readonly bool disableAssemblyScanning;
        ...
        bool disableAssemblyScanning, IValidator? validator, FluentValidationValidator fluentValidationValidator)
    {
        ...
        this.disableAssemblyScanning = disableAssemblyScanning;
        this.validator = validator;
        this.fluentValidationValidator = fluentValidationValidator;
